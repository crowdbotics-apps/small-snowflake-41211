"""
Django settings for small_snowflake_41211 project.
...
ROOT_URLCONF = 'small_snowflake_41211.urls'
...
WSGI_APPLICATION = 'small_snowflake_41211.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_snowflake_41211 API",
    "DESCRIPTION": "API documentation for small_snowflake_41211 App",
    "VERSION": "v1",
}
